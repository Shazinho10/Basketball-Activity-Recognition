...
vid_path = "testing_videos/magnify_videos/f6651fd-52c1-3f5-0417-3c634a0ffe8mp4.mp4"
                    ...
                    if region != 0 and region is not None:
                      ...
                      # if a two point shot has been made from the two point region
                        ...
                        #   foot = ft
                          ...
                          # fty = foot[1]
                          try:
                            future_image = track_back_storing[3]
...
if __name__ == "__main__":
  video_path = "testing_videos/magnify_videos/f2ee5fe-86e-2b17-2d7-650f0140bdmp4.mp4"
  even_classification = Shot_Classification(video_path, visualise=False)
